...
void MyMesh::GenerateCube(float width) {
	std::vector<vector3> points;
	width /= 2;
	points.push_back(vector3(width, width, -width));
	points.push_back(vector3(width, -width, -width));
	points.push_back(vector3(-width, width, -width));
	points.push_back(vector3(-width, -width, -width));
	...
	//Plane A
	AddVertexPosition(points[0]);
	AddVertexPosition(points[1]);
	AddVertexPosition(points[2]);

	AddVertexPosition(points[1]);
	AddVertexPosition(points[3]);
	AddVertexPosition(points[2]);

	//Plane B
	AddVertexPosition(points[4]);
	AddVertexPosition(points[5]);
	AddVertexPosition(points[6]);

	AddVertexPosition(points[5]);
	AddVertexPosition(points[7]);
	AddVertexPosition(points[6]);
