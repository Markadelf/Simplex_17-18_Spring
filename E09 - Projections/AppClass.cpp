...
void Application::Display(void)
{
	...
	case 3:
		m_pCamera->ResetCamera();
		m_pCamera->SetPositionTargetAndUp(vector3(30, 0, 0), vector3(1, 0, 0), vector3(0, 0, -1));
		break;
	case 4:
		m_pCamera->ResetCamera();
		m_pCamera->SetPositionTargetAndUp(vector3(0, 0, -15), vector3(0, 0, 0), vector3(0, 1, 0));
		break;
	case 5:
		m_pCamera->ResetCamera();
		m_pCamera->SetPositionTargetAndUp(vector3(0, 0, -15), vector3(0, 0, 0), vector3(0, 1, 0));
		m_pCamera->SetNearFar(vector2(5, 20));
		break;
	case 6:
		m_pCamera->ResetCamera();
		m_pCamera->SetPositionTargetAndUp(vector3(0, 0, -15), vector3(0, 0, 0), vector3(0, 1, 0));
